...
public class Main2 {
	...
	private static String listAliveMinirobots() {
		...
		for(int i = 0; i<engine.miniRobots.size();i++){
			ki.append(engine.miniRobots.get(i).getID());																						//robot ID ki�r�sa
			ki.append(" " + engine.miniRobots.get(i).getPosition().getX() + "," + engine.miniRobots.get(i).getPosition().getY());			//robot poz�ci� ki�r�sa
			//ki.append(" " + engine.miniRobots.get(i).getImpulse().getX() + "," + engine.miniRobots.get(i).getImpulse().getY());				//robot impulzus ki�r�sa			//Modositva, minbotoknak nem kell
			ki.append(" " + engine.miniRobots.get(i).getRoad());																				//robot megtett �tj�nak ki�r�sa TODO
			ki.append("\n");
		}
		ki.append("\n");
		return ki.toString();
	...
	private static String listAliveRobots() {
		...
		for(int i = 0; i<engine.alivePlayers.size();i++){
			ki.append(engine.alivePlayers.get(i).getID());																						//robot ID ki�r�sa
			ki.append(" " + engine.alivePlayers.get(i).getPosition().getX() + "," + engine.alivePlayers.get(i).getPosition().getY());			//robot poz�ci� ki�r�sa
			ki.append(" " + engine.alivePlayers.get(i).getImpulse().getX() + "," + engine.alivePlayers.get(i).getImpulse().getY());				//robot impulzus ki�r�sa
			ki.append(" " + engine.alivePlayers.get(i).getRoad());																				//robot megtett �tj�nak ki�r�sa
			ki.append("\n");
		}
		ki.append("\n");
		return ki.toString();
	...
	private static String listTraps() {
		...
		for(int i = 0; i<engine.traps.size();i++){
			//ki.append(engine.traps.get(i).getID());																						//robot ID ki�r�sa (ha lesz) TODO
			ki.append(/*" " + */engine.traps.get(i).getPos().getX() + "," + engine.traps.get(i).getPos().getY());			//robot poz�ci� ki�r�sa
			// TODO: Ide kell m�g, hogy ki�rja, hogy slime/oil.
